                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark justify-content-center">
                        <ul class="navbar-nav">
                            <li><a class="btn btn-outline-primary border border-dark" style="color: black;"
                                href="<?= base_url('admin/users')?>">Usuarios👤</a></li><br>
                            <li><a class="btn btn-outline-success border border-dark" style="color: black;"
                                href="<?= base_url('admin/equipos')?>">Equipos🖥️</a></li><br>
                                <li><a class="btn btn-outline-success border border-dark" style="color: black;"
                                href="<?= base_url('admin/mobiliario')?>">Mobiliario🪑</a></li><br>
                            <li><a class="btn btn-outline-warning border border-dark" style="color: black;"
                                href="<?= base_url('admin/mantenimiento')?>">Mantenimiento⚙️</a></li><br>
                                <li><a class="btn btn-outline-warning border border-dark" style="color: black;"
                                href="<?= base_url('admin/proveedores')?>">Proveedores🚛</a></li><br>
                        </ul>
                    </nav>
            </div>
        </div>
